...
TE_COL_NUM = 1  # The column number of the total energy in ener_box#.output

num_temps = 10  # Last TEMP # + 1 (start counting at 1)
NUM_ITERATIONS = 25001  # The number of energies to be taken and analyzed, starting from the last
